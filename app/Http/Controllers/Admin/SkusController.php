...
class SkusController extends Controller
{
    public function Sku(){
        ...
        $type = Goods_type::get();
        // dd($type);
        return view("admin.skus.sku",compact("data","brand_data","type"));
    }
    //无限极分类
...
//        dd($array);
    ...
    public function type_attr(){
        ...
        // dd($data);
        return view("admin.skus.type_attr",compact("data"));
    }
    ...
    public function item_show($goods_id){
        ...
        //  dump($attrs_new_key);
        return view("admin.skus.item_show",compact("attrs_new_key","goods"));
    }
